...
##### To the variables you're analzying from the top cluster results
i <- 1
...
ord_log_health <- clm(factor(health) ~ rank, data = ord_log_data)
res_health <- summary(ord_log_health)

##### Let H1 be the alternative hypothesis
##### For H1: beta < 0 set lower = TRUE, for beta > 0, set lower = FALSE
