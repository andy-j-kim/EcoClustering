---
title: "Economic Clustering Summary Report: Burkina Faso 2021"
output: 
  word_document:
...
hh_path <- "~/Library/CloudStorage/Box-Box/Project 1/DHS Data/BURKINA FASO (2021) STANDARD DHS DATASET/BURKINA FASO (2021) STANDARD DHS DATASET/BF_2021_DHS_03242024_826_171933/BFHR81DT/BFHR81FL.DTA"
ind_path <- "~/Library/CloudStorage/Box-Box/Project 1/DHS Data/BURKINA FASO (2021) STANDARD DHS DATASET/BURKINA FASO (2021) STANDARD DHS DATASET/BF_2021_DHS_03242024_826_171933/BFIR81DT/BFIR81FL.DTA"
```
...
ord_log_data <- ord_log_fxn2(data = dhs, i=1, tab=top_varset_table, 
                             ...
                             levels = list(floor = c(natural = 0, rudimentary = 0.5, 
                                                    other = 0.5, finished = 1),
                                           roof = c(natural = 0, rudimentary = 0.5, 
                                                    other = 0.5, finished = 1)))
