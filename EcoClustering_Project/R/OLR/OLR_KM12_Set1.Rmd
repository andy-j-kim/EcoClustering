---
title: "Economic Clustering Summary Report: Comoros 2012"
output: 
  word_document:
...
hh_path <- "~/Library/CloudStorage/Box-Box/Project 1/DHS Data/COMOROS 2012/KMHR61DT/KMHR61FL.DTA"
ind_path <- "~/Library/CloudStorage/Box-Box/Project 1/DHS Data/COMOROS (KM) 2012/KMIR61DT/KMIR61FL.DTA"
```
...
# need a workaround for Comoros, cleaning pattern was a bit rough (fix later)
# vars.for.filt <- haven::read_dta(hh_path) %>% 
...
merged_dhs <- hh %>% 
  ...
  dplyr::filter(v149 != 9) # added for Comoros specifically, gets rid of 15 inds, doesn't change order
  # of other tables
