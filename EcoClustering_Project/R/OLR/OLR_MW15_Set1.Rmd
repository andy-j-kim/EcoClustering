...
hh_path <- "~/Box/Project 1/DHS Data/MALAWI (2015-16) STANDARD DHS DATASET/MALAWI (2015-16) STANDARD DHS DATASET/MW_2015-16_DHS_03242024_659_171933/MWHR7ADT/MWHR7AFL.DTA"
ind_path <- "~/Box/Project 1/DHS Data/MALAWI (2015-16) STANDARD DHS DATASET/MALAWI (2015-16) STANDARD DHS DATASET/MW_2015-16_DHS_03242024_659_171933/MWIR7ADT/MWIR7AFL.DTA"
```
...
ord_log_data <- ord_log_fxn(data = dhs, i=1, tab=top_varset_table, 
                            ...
                            levels = list(floor = c("rudimentary","natural","other","finished")))
