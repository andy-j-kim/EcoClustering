...
hh_path <- "~/Box/Project 1/DHS Data/SENEGAL 2019/SNHR8BDT/SNHR8BFL.DTA"
ind_path <- "~/Box/Project 1/DHS Data/SENEGAL (SN) 2019/SNIR8BDT/SNIR8BFL.DTA"
```
...
ord_log_data <- ord_log_fxn(data = dhs, i=1, tab=top_varset_table, 
                            ...
                            list(floor = c("rudimentary","natural","finished")))
