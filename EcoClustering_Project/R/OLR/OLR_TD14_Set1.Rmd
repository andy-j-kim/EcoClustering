...
ord_log_data <- ord_log_fxn(data = dhs, i=1, tab=top_varset_table, 
                            ...
                            list(cookfuel = c("animal dung", "straw/shrubs/grass", "agricultural crop", "wood", "coal, lignite", "charcoal", "kerosene", "other", "biogas", "no food cooked in house",  "lpg", "natural gas", "electricity")))
