---
title: "Economic Clustering Summary Report: Chad 2014"
output: 
  word_document:
...
hh_path <- "~/Library/CloudStorage/Box-Box/Project 1/DHS Data/CHAD (2014-2015) STANDARD DHS DATASET/CHAD (2014-2015)STANDARD DHS DATA/TD_2014-15_DHS_04032024_1319_171933/TDHR71DT/TDHR71FL.DTA"
ind_path <- "~/Library/CloudStorage/Box-Box/Project 1/DHS Data/CHAD (2014-2015) STANDARD DHS DATASET/CHAD (2014-2015)STANDARD DHS DATA/TD_2014-15_DHS_04032024_1319_171933/TDIR71DT/TDIR71FL.DTA"
```
...
ord_log_data <- ord_log_fxn2(data = dhs, i=1, tab=top_varset_table, 
                             ...
                             levels = list(cookfuel = c("animal dung" = 0, "straw/shrubs/grass" = 0,
                                               "agricultural crop" = 0, wood = 0, coal  = 0,
                                               lignite = 0, charcoal = 0, kerosene = 0,
                                               other = 0.5, biogas = 0.5, 
                                               "no food cooked in house" = 0.5,
                                               lpg = 0.5, "natural gas" = 1, electricity = 1)))
