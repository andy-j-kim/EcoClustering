...
hh_path <- "~/Box/Project 1/DHS Data/TOGO (2013-2014) STANDARD DHS DATASET/TOGO (2013-2014 STANDARD DHS DATASET)/TG_2013-14_DHS_03242024_611_171933/TGHR61DT/TGHR61FL.DTA"
ind_path <- "~/Box/Project 1/DHS Data/TOGO (2013-2014) STANDARD DHS DATASET/TOGO (2013-2014 STANDARD DHS DATASET)/TG_2013-14_DHS_03242024_611_171933/TGIR61DT/TGIR61FL.DTA"
```
...
ord_log_data <- ord_log_fxn(data = dhs, i=1, tab=top_varset_table, 
                            ...
                            levels = list(roof = c(natural = 0,rudimentary = 0.5,other=0.5,finished=1)))
