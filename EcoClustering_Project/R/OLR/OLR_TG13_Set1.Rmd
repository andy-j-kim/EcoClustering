---
title: "Economic Clustering Summary Report: Togo 2013-14"
output: 
  word_document:
...
hh_path <- "~/Library/CloudStorage/Box-Box/Project 1/DHS Data/TOGO (2013-2014) STANDARD DHS DATASET/TOGO (2013-2014 STANDARD DHS DATASET)/TG_2013-14_DHS_03242024_611_171933/TGHR61DT/TGHR61FL.DTA"
ind_path <- "~/Library/CloudStorage/Box-Box/Project 1/DHS Data/TOGO (2013-2014) STANDARD DHS DATASET/TOGO (2013-2014 STANDARD DHS DATASET)/TG_2013-14_DHS_03242024_611_171933/TGIR61DT/TGIR61FL.DTA"
```
...
ord_log_data <- ord_log_fxn2(data = dhs, i=1, tab=top_varset_table, 
                             ...
                             levels = list(roof = c(natural = 0, rudimentary = 0.5, 
                                                    other = 0.5, finished = 1)))
...
```{r}
# NOTES
# Preprocess HH data differently (use non-adj version)
# Add cluster_dist_IDs to function to run quicker
# Changed levels argument
# Used relative proportions to ore accurately rank cluster nodes
```
