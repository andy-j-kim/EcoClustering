...
dataset <- haven::read_dta("~/Box/Project 1/DHS Data/BURKINA FASO (2021) STANDARD DHS DATASET/BURKINA FASO (2021) STANDARD DHS DATASET/BF_2021_DHS_03242024_826_171933/BFHR81DT/BFHR81FL.DTA")
...
dataclean <- dataset %>% 
  ...
  #7
  dplyr::select(-c(hv246a, hv246h, hv246j, hv252)) %>% 
