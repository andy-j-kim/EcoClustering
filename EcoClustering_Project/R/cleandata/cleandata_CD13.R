...
dataset <- haven::read_dta("~/Box/Project 1/DHS Data/CONGO DEMOCRATIC 2013-14/CDHR61DT/CDHR61FL.DTA")
...
dataclean <- dataset %>% 
  ...
  #7
  dplyr::select(-starts_with("sh136"), -c(hv246d, hv246e, hv246g, hv246h, hv252)) %>% 
