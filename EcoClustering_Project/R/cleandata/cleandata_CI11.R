...
dataset <- haven::read_dta("~/Box/Project 1/DHS Data/IVORY COAST 2011-12/CIHR62DT/CIHR62FL.DTA")
...
dataclean <- dataset %>% 
  ...
  #7
  dplyr::select(-c(hv246a, hv246b, hv246d, hv246e, hv246g, hv252, sh106a, sh106b, sh106c)) %>% 
