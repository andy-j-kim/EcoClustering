...
dataset <- haven::read_dta("~/Box/Project 1/DHS Data/GHANA (2022) STANDARD DHS DATASET/GHANA (2022) STANDARD DHS DATASET/GH_2022_DHS_03242024_631_171933/GHHR8ADT/GHHR8AFL.DTA")
