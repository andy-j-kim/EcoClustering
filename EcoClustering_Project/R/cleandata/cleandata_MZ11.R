...
dataset <- haven::read_dta("~/Box/Project 1/DHS Data/MOZAMBIQUE (2011) STANDARD DHS DATASET/MOZAMBIQUE (2011) STANDARD DHS DATASET/MZ_2011_DHS_03242024_719_171933/MZHR62DT/MZHR62FL.DTA")
...
dataclean <- dataset %>% 
  ...
  #7
  dplyr::select(-c(hv234a, hv246b, hv246g, hv252, hv253a)) %>% 
