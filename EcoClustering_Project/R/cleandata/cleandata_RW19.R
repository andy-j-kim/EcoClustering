...
dataset <- haven::read_dta("~/Box/Project 1/DHS Data/RWANDA_2019/RWHR81DT/RWHR81FL.DTA")
...
dataclean <- dataset %>% 
  ...
  #7
  dplyr::select(-c(hv237a, hv246a, hv246d, hv246e, hv246f, hv246g, hv246h, hv246i,
                   hv252, sh144a), -starts_with("sh112")) %>% 
