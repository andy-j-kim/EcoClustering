...
dataset <- haven::read_dta("~/Box/Project 1/DHS Data/SENEGAL 2019/SNHR8BDT/SNHR8BFL.DTA")
...
dataclean <- dataset %>% 
  ...
  #7
  dplyr::select(-c(hv237b, hv237c, hv246c, hv246h, sh123a,
                   hv252, sh145a, sh152a), -starts_with("sh151"), -starts_with("sh163")) %>% 
