...
dataset <- haven::read_dta("~/Box/Project 1/DHS Data/TOGO (2013-2014) STANDARD DHS DATASET/TOGO (2013-2014 STANDARD DHS DATASET)/TG_2013-14_DHS_03242024_611_171933/TGHR61DT/TGHR61FL.DTA")
...
dataclean <- dataset %>% 
  ...
  #7
  dplyr::select(-c(hv246b, hv246e, hv246g, hv246i, hv252, sh123a)) %>% 
