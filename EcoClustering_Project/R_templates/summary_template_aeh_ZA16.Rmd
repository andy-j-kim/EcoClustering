---
title: "Output For Looking at Our Clusters vs. DHS Clusters"
subtitle: "South Africa (ZA16)"
output: 
  word_document:
...
source("/Users/hubbard/UC Berkeley Biostat Dropbox/Alan Hubbard/hubbardlap/grantproposals/Data Science in Africa/Project 1/EcoClustGit/EcoClustering_Project/input_files/EC_user_functions[aeh].R")
```

```{r set params and paths}
cy <- "ZA16" # country-year code
...
dhspath <- paste0("/Users/hubbard/UC Berkeley Biostat Dropbox/Alan Hubbard/hubbardlap/grantproposals/Data Science in Africa/Project 1/EcoClustGit/EcoClustering_Project/data/cleaned/", cy, "_clean.rds")

# Path to the ASW output file
#aswpath <- paste0("./data/asw/ASW_", cy, "_", num_var, "cluster.rds")
aswpath <- paste0("/Users/hubbard/UC Berkeley Biostat Dropbox/Alan Hubbard/hubbardlap/grantproposals/Data Science in Africa/Project 1/EcoClustGit/EcoClustering_Project/data/asw/ASW_", cy, "_", num_var, "cluster.rds")
...
hh_path <- "/Users/hubbard/UC Berkeley Biostat Dropbox/Alan Hubbard/hubbardlap/grantproposals/Data Science in Africa/Project 1/EcoClustGit/EcoClustering_Project/data/dhs/SouthAfrica_2016/ZAHR71DT/ZAHR71FL.DTA"
ind_path <-"/Users/hubbard/UC Berkeley Biostat Dropbox/Alan Hubbard/hubbardlap/grantproposals/Data Science in Africa/Project 1/EcoClustGit/EcoClustering_Project/data/dhs/SouthAfrica_2016/ZAIR71DT/ZAIR71FL.DTA"
...
## Write out data for association of DHS cluster and our clusters
write_csv(merged_dhs,file="/Users/hubbard/UC Berkeley Biostat Dropbox/Alan Hubbard/hubbardlap/grantproposals/Data Science in Africa/Project 1/EcoClustGit/EcoClustering_Project/data/DataforAlan/SouthAfrica.csv")
```

### merged_dhs has all the variables I need for the comparison of our clusters to DHS. "id" is the cluster number.
